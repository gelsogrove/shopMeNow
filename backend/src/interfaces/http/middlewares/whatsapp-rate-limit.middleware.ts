...
const WORKSPACE_LIMIT = parseInt(process.env.WHATSAPP_MAX_MESSAGES_PER_MINUTE_WORKSPACE || '100')
const CUSTOMER_LIMIT = parseInt(process.env.WHATSAPP_MAX_MESSAGES_PER_MINUTE_CUSTOMER || '10')
