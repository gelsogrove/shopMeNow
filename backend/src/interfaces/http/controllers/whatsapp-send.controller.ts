...
export class WhatsAppSendController {
  ...
  async sendMessage(req: Request, res: Response): Promise<void> {
    try {
      ...
      const { workspaceId, customerId, phoneNumber, message } = req.body as SendMessageRequest
      ...
      if (!chatSession) {
        logger.info('[WHATSAPP-SEND] Creating new chat session', { customerId, workspaceId })
