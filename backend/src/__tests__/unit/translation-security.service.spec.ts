...
describe("🔒 Translation & Security Service", () => {
  ...
  describe("Service Health", () => {
    it("should exist and be active", async () => {
      console.log("\n🧪 TEST: Verify TranslationSecurityService exists\n")
  ...
  describe("Profanity Filtering", () => {
    it("should block Italian profanity", async () => {
      ...
      console.log(`   Input: "Vaffanculo stronzo di merda"`)
    ...
    it("should block Spanish profanity", async () => {
      ...
      console.log(`   Input: "Eres un hijo de puta cabrón"`)
      console.log(`   Blocked: ${result.blocked}`)
      console.log(`   Reason: ${result.reason}`)
      console.log(`   Output: "${result.translatedText}"`)
    ...
    it("should block English profanity", async () => {
      ...
      console.log(`   Input: "Fuck you asshole bitch"`)
      console.log(`   Blocked: ${result.blocked}`)
      console.log(`   Reason: ${result.reason}`)
      console.log(`   Output: "${result.translatedText}"`)
