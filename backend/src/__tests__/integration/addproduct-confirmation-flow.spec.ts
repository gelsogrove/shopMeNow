...
describe("🧪 addProduct Confirmation Flow - Integration Test", () => {
  ...
  describe("📦 addProduct Confirmation Flow", () => {
    ...
    it(
      "STEP 1: Should ask confirmation when user requests to add product (NOT call addProduct yet)",
      async () => {
        console.log("\n" + "─".repeat(80))
        console.log("📝 STEP 1: Prima richiesta - Utente chiede di aggiungere prodotto")
    ...
    it(
      "STEP 2: Should call addProduct() when user confirms with 'si'",
      async () => {
        console.log("\n" + "─".repeat(80))
