...
const testFile = path.join(__dirname, 'src/__tests__/unit/translation-security.service.spec.ts');
...
const testsToUpdate = [
  {
    ...
    response: "I'm sorry, I can't help you with that. How can I assist you with our products?",
    blocked: true,
    reason: 'profanity',
    assertion: 'I\'m sorry'
  },
  {
    ...
    response: 'Desculpe, não posso ajudar com isso. Como posso ajudá-lo com nossos produtos?',
    blocked: true,
    reason: 'profanity',
    assertion: 'Desculpe'
  },
  ...
  },
  {
    ...
    response: 'Lo siento, no puedo ayudarte con eso. ¿Cómo puedo ayudarte con nuestros productos?',
    blocked: true,
    reason: 'phishing',
    assertion: 'Lo siento'
  },
...
console.log('✅ Script ready - manual implementation recommended for precision\n');
