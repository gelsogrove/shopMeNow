...
> **Runtime source of truth**: [`apps/backend/custom-ecolaundry/prompts/history.txt`](../../../apps/backend/custom-ecolaundry/prompts/history.txt)
...
I prompt del Flow Engine ([`json/lavatrice_hs60xx.json`](../../../apps/backend/custom-ecolaundry/json/lavatrice_hs60xx.json) e [`json/asciugatrice_ed340.json`](../../../apps/backend/custom-ecolaundry/json/asciugatrice_ed340.json)) e le `localization.QUESTIONS` sono **scritti direttamente in spagnolo** con tono "tranquilo".
...
- `es` = Spanish (default base per ecolaundry)
- `it` = Italian
- `pt` = Portuguese
- `ca` = Catalan
- `fr` = French
