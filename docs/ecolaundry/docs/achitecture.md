...
> Visual source of truth: `docs/ecolaundry/docs/LLMarchetecture.png`.
...
When a workspace has `customChatbotId` set (e.g., `"ecolaundry"`) and `channelMode = FLOW`, the webhook routes the message to the custom pipeline instead of the standard multi-agent system.
...
This rule is defined in `apps/backend/custom-ecolaundry/prompts/history.txt` under `FIRST TURN WELCOME RULE`.
...
The CLI demo runner (`apps/backend/custom-ecolaundry/chatbot.ts --scripted`) always calls `handleTurn()` directly.
...
- `docs/ecolaundry/docs/prompt1-router.md`
- `docs/ecolaundry/docs/subllm-laundry.md`
- `docs/ecolaundry/docs/subllm-asciugatrice.md`
- `docs/ecolaundry/docs/prompt3-history.md`
...
| Role | File | Path |
|---|---|---|
| Router | [prompt1-router.md](./prompt1-router.md) | `docs/ecolaundry/docs/prompt1-router.md` |
| Washer Specialist | [subllm-laundry.md](./subllm-laundry.md) | `docs/ecolaundry/docs/subllm-laundry.md` |
| Dryer Specialist | [subllm-asciugatrice.md](./subllm-asciugatrice.md) | `docs/ecolaundry/docs/subllm-asciugatrice.md` |
| Conversation History | [prompt3-history.md](./prompt3-history.md) | `docs/ecolaundry/docs/prompt3-history.md` |
| Escalation | [prompt4_contact.md](./prompt4_contact.md) | `docs/ecolaundry/docs/prompt4_contact.md` |
| Reset | [prompt5_reset.md](./prompt5_reset.md) | `docs/ecolaundry/docs/prompt5_reset.md` |

### Flow JSON

| Role | File | Path |
|---|---|---|
| Washer flow | [lavatrice_hs60xx.json](./json/lavatrice_hs60xx.json) | `docs/ecolaundry/docs/json/lavatrice_hs60xx.json` |
| Dryer flow | [asciugatrice_ed340.json](./json/asciugatrice_ed340.json) | `docs/ecolaundry/docs/json/asciugatrice_ed340.json` |

### Supporting docs

| Role | File | Path |
|---|---|---|
| Scenarios | [escenario.md](./escenario.md) | `docs/ecolaundry/docs/escenario.md` |
| Variables | [variables.md](./variables.md) | `docs/ecolaundry/docs/variables.md` |
| Visual architecture | [LLMarchetecture.png](./LLMarchetecture.png) | `docs/ecolaundry/docs/LLMarchetecture.png` |
