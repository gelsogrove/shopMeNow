...
├── customChatbotId        ✅ modulo chatbot custom     — seleziona custom-client-N (es. "ecolaundry"). Quando impostato + channelMode=FLOW → bypassa AI agents standard e usa chatbotFn custom.
