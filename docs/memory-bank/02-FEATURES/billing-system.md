...
| MONTHLY_CHANNEL_COST | 59.00        | Costo fisso mensile del canale                          | 📆    |
...
- `trackMonthlyChannelCost(workspaceId, description)`: Traccia il costo fisso mensile del canale (€59.00)
...
| Primo giorno di ogni mese | MONTHLY_CHANNEL_COST (€59.00) | Canone mensile fisso per il canale di comunicazione    | `scheduler.service.ts` - `trackMonthlyChannelCost()`         |
