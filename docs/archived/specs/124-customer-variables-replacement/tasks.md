...
1. **Link Token Replacement**: Replace supported link placeholders (e.g., `[LINK_PROFILE_WITH_TOKEN]`) with actual URLs (JWT-secured)
...
INPUT: "Hi {{nameUser}}, you have {{discountUser}}% off! Link: [LINK_PROFILE_WITH_TOKEN]"
