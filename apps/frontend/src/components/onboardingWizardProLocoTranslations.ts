...
export const OWPL: Record<OWTLang, {
  ...
  it: {
    business: {
      ...
      phoneHint: 'Con prefisso internazionale, es. +39 — potete collegarlo anche dopo',
    },
  ...
  en: {
    business: {
      ...
      phoneHint: 'With country code, e.g. +39 — optional, you can connect it later',
    },
  ...
  es: {
    business: {
      ...
      phoneHint: 'Con prefijo internacional, ej. +39 — podéis conectarlo más tarde',
    },
