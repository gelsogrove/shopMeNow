...
export const OWPL: Record<OWTLang, {
  ...
  ca: {
    business: {
      ...
      phone: 'Número de WhatsApp del chatbot',
      phoneHint: 'És el número des del qual respondrà l\'assistent als turistes. Amb prefix internacional, ex. +39 — podeu connectar-lo més tard',
    },
  ...
  fr: {
    business: {
      ...
      phone: 'Numéro WhatsApp du chatbot',
      phoneHint: 'C\'est le numéro depuis lequel l\'assistant répondra aux visiteurs. Avec l\'indicatif international, ex. +39 — vous pouvez le connecter plus tard',
    },
  ...
  de: {
    business: {
      ...
      subtitle: 'Ihre Touristen sehen diesen Namen auf WhatsApp',
      name: 'Name des Tourismusbüros',
      namePh: 'z.B. Tourismusbüro Sappada',
      phone: 'WhatsApp-Nummer des Chatbots',
      phoneHint: 'Dies ist die Nummer, von der aus der Assistent antwortet. Mit Landesvorwahl, z.B. +39 — Sie können sie auch später verbinden',
    },
