...
export function HomeShowcase({ lang = "en" }: { lang?: Lang }) {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-3xl border border-white/10 bg-[#070d18] p-6 shadow-2xl sm:p-8 lg:p-10">
      ...
      <Link
        to="/demo/demowash"
        className="absolute right-5 top-5 z-20 inline-flex items-center gap-2 rounded-full px-5 py-3 text-sm font-bold text-white shadow-lg transition hover:brightness-110 sm:right-8 sm:top-8"
