...
export function PrivacyDataflowDiagram({ labels }: { labels: DataflowLabels }) {
  ...
  return (
    ...
    >
      ...
      {/* Customer */}
      <g>
        <rect x="44" y="135" width="176" height="160" rx="16" fill="#f8fafc" stroke="#e2e8f0" />
        ...
        <text x="132" y="244" textAnchor="middle" fill="#0f172a" fontSize="15" fontWeight="600">{labels.customer}</text>
      ...
      <text x="263" y="205" textAnchor="middle" fill="#64748b" fontSize="11.5">{labels.channel}</text>
      ...
      <g>
        ...
        <text x="374" y="111" fill="#0f172a" fontSize="15.5" fontWeight="600">{labels.instanceTitle}</text>
        <text x="374" y="126" fill="#64748b" fontSize="11.5">{labels.instanceSub}</text>

        {/* database pill */}
        <rect x="334" y="146" width="256" height="38" rx="9" fill="#f8fafc" stroke="#e2e8f0" />
        ...
        <text x="374" y="170" fill="#334155" fontSize="13">{labels.database}</text>

        {/* knowledge base pill */}
        <rect x="334" y="192" width="256" height="38" rx="9" fill="#f8fafc" stroke="#e2e8f0" />
        ...
        <text x="374" y="216" fill="#334155" fontSize="13">{labels.knowledgeBase}</text>

        {/* RAG pill */}
        <rect x="334" y="238" width="256" height="38" rx="9" fill="#f8fafc" stroke="#e2e8f0" />
        <g transform="translate(350,251)" stroke="#25D366" strokeWidth="1.6" fill="none" strokeLinecap="round">
          <circle cx="5" cy="5" r="4.5" />
          <line x1="8.5" y1="8.5" x2="12" y2="12" />
        </g>
        <text x="374" y="262" fill="#334155" fontSize="13">{labels.rag}</text>
      ...
      <text x="656" y="140" textAnchor="middle" fill="#64748b" fontSize="11">{ctxLine1}</text>
      {ctxLine2 && <text x="656" y="153" textAnchor="middle" fill="#64748b" fontSize="11">{ctxLine2}</text>}
      ...
      {/* External LLM */}
      <g>
        <rect x="702" y="135" width="152" height="140" rx="16" fill="#f8fafc" stroke="#e2e8f0" />
        ...
        <text x="778" y="222" textAnchor="middle" fill="#0f172a" fontSize="13" fontWeight="600">{llmLine1}</text>
        {llmLine2 && (
          <text x="778" y="239" textAnchor="middle" fill="#0f172a" fontSize="13" fontWeight="600">{llmLine2}</text>
        )}
