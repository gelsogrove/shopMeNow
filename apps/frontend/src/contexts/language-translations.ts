...
export const translations = {
  it: {
    ...
    "demohouse.subtitle": "DemoHouse è un'agenzia immobiliare fittizia con più filiali in Catalogna. Prova il chatbot come se fossi un cliente: chiedi quali case sono disponibili nella tua zona, prenota una visita, richiedi una valutazione gratuita, e vedi come il caso scala all'agente umano con traduzione in tempo reale.",
  ...
  en: {
    ...
    "demohouse.subtitle": "DemoHouse is a fictional real-estate agency with several branches across Catalonia. Try the chatbot like a real client would: ask which homes are available in your area, book a viewing, request a free valuation, and see how the case escalates to a human agent with real-time translation.",
  ...
  es: {
    ...
    "demohouse.subtitle": "DemoHouse es una agencia inmobiliaria ficticia con varias oficinas en Cataluña. Prueba el chatbot como si fueras un cliente real: pregunta qué viviendas hay disponibles en tu zona, reserva una visita, pide una valoración gratuita, y mira cómo el caso escala a un agente humano con traducción en tiempo real.",
