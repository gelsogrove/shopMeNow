...
// DemoCasa is only the running EXAMPLE — the product fits residential,
...
export const REAL_ESTATE_I18N: Record<RealEstateLang, RealEstateCopy> = {
  it: {
    ...
    industriesSub:
      "L'esempio che vedi è DemoCasa, un'agenzia immobiliare. Ma la stessa AI lavora con qualsiasi tipologia di immobile.",
    industries: [
    ...
    actsPromoCard: "DemoCasa · Consulenza mutuo",
  ...
  en: {
    ...
    industriesSub:
      "The example you see is DemoCasa, a real estate agency. But the same AI works for any type of property.",
    industries: [
    ...
    actsPromoCard: "DemoCasa · Mortgage advisor",
  ...
  es: {
    ...
    industriesSub:
      "El ejemplo que ves es DemoCasa, una agencia inmobiliaria. Pero la misma IA funciona con cualquier tipo de inmueble.",
    industries: [
    ...
    actsPromoCard: "DemoCasa · Asesor hipotecario",
  ...
  de: {
    ...
    industriesSub:
      "Das Beispiel, das du siehst, ist DemoCasa, eine Immobilienagentur. Aber dieselbe KI funktioniert für jede Art von Immobilie.",
    industries: [
    ...
    actsPromoCard: "DemoCasa · Finanzierungsberater",
