...
const T: Record<Language, {
  ...
  it: {
    ...
    faqs: [
      ...
      { q: "I dati sono al sicuro? GDPR?", a: "Assolutamente sì. eChatbot è conforme GDPR. I dati sono cifrati AES-256 at-rest e in transito con TLS 1.3. Zero-knowledge architecture. Vedi la pagina Privacy by Design per tutti i dettagli." },
  ...
  en: {
    ...
    faqs: [
      ...
      { q: "Is data secure? GDPR?", a: "Absolutely yes. eChatbot is GDPR compliant. Data is encrypted AES-256 at-rest and in transit with TLS 1.3. Zero-knowledge architecture. See the Privacy by Design page for full details." },
  ...
  es: {
    ...
    faqs: [
      ...
      { q: "¿Los datos están seguros? ¿GDPR?", a: "Absolutamente sí. eChatbot es conforme con GDPR. Los datos están cifrados AES-256 at-rest y en tránsito con TLS 1.3. Arquitectura zero-knowledge. Ver la página de Privacy by Design para todos los detalles." },
  ...
  pt: {
    ...
    faqs: [
      ...
      { q: "Os dados estão seguros? GDPR?", a: "Absolutamente sim. O eChatbot está em conformidade com GDPR. Os dados são criptografados AES-256 at-rest e em trânsito com TLS 1.3. Arquitetura zero-knowledge. Veja a página Privacy by Design para todos os detalhes." },
      ...
      <main>
        ...
        <section className="py-20 bg-gradient-to-br from-green-600 to-emerald-700">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <Link to="/onboarding" className="inline-flex items-center gap-3 bg-white hover:bg-slate-50 text-green-600 font-semibold px-10 py-5 rounded-2xl shadow-lg text-lg transition-all">
