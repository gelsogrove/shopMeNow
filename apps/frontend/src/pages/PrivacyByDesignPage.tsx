    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="py-20 bg-gradient-to-b from-slate-50 to-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <h2 className="text-4xl font-bold text-slate-900 text-center mb-14">{t.complianceTitle}</h2>
              ...
              {t.complianceItems.map((c, i) => (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm font-semibold text-green-700 bg-green-100 px-3 py-1 rounded-full">{c.status}</span>
                  </div>
                  <p className="text-slate-500 text-sm mb-4">{c.region}</p>
