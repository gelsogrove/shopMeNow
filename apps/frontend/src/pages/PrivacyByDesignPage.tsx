          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              ...
              <div className="relative">
                ...
                <img src="/survery-secuiry.png" alt="Privacy Architecture" style={{ filter: "saturate(0.7) brightness(1.06)" }} className="relative w-full h-auto rounded-3xl shadow-2xl border border-white/10 object-contain" />
              </div>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="relative order-2 lg:order-1">
                ...
                <img src="/survery-secuiry.png" alt="Security Architecture" style={{ filter: "saturate(0.7) brightness(1.06)" }} className="relative w-full h-auto rounded-2xl shadow-2xl border border-white/10 object-contain" />
              </div>
