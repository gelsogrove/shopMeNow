      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="px-6 py-8">
          <p className="text-gray-700 text-lg text-center mb-6">
            Thank you for completing your registration. You can now return to
            WhatsApp to continue your conversation.
          </p>
          ...
          <ul className="space-y-3 text-gray-600">
            ...
            <li className="flex items-start">
              ...
              <p className="ml-3">
                You can now browse products and services via WhatsApp
              </p>
            </li>
            <li className="flex items-start">
              <div className="flex-shrink-0">
              ...
              <p className="ml-3">
                Your preferences have been saved and will be used to personalize
                your experience
              </p>
            </li>
          </ul>
