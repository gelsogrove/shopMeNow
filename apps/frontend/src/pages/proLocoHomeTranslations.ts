...
const it: HomeCopy = {
  ...
  slogan2: "su WhatsApp",
  lede: "Un assistente che incrocia il meteo, le esigenze dell'ospite e le informazioni del territorio per assisterlo durante tutta la vacanza.",
...
const en: HomeCopy = {
  ...
  slogan2: "on WhatsApp",
  lede: "An assistant that combines the weather, each guest's own needs and your local knowledge to help them throughout their holiday.",
...
const es: HomeCopy = {
  ...
  lede: "Un asistente que cruza el tiempo, las necesidades del huésped y la información del territorio para acompañarlo durante toda su estancia.",
...
const ca: HomeCopy = {
  ...
  lede: "Un assistent que creua el temps, les necessitats de l'hoste i la informació del territori per acompanyar-lo durant tota l'estada.",
...
const fr: HomeCopy = {
  ...
  lede: "Un assistant qui croise la météo, les envies de chaque visiteur et les informations du territoire pour l'accompagner tout au long de son séjour.",
...
const de: HomeCopy = {
  ...
  lede: "Ein Assistent, der Wetter, die Wünsche des Gastes und Ihr lokales Wissen verbindet, um ihn durch den ganzen Urlaub zu begleiten.",
