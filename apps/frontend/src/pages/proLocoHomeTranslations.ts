...
const it: HomeCopy = {
  ...
  closingTitle: "Cento volte la stessa domanda",
  closingBody: "Dove sono i bagni, a che ora apre la funivia, si mangia senza glutine da qualche parte. Ogni giorno, allo sportello e al telefono, spesso mentre c'è la fila. Da adesso arrivano all'assistente: voi restate per le cose che meritano una persona.",
...
const en: HomeCopy = {
  ...
  closingTitle: "The same question, a hundred times",
  closingBody: "Where are the toilets, when does the cable car open, is there anywhere gluten-free. Every day, at the desk and on the phone, usually with a queue waiting. From now on they go to the assistant — you stay for the things that deserve a person.",
...
const es: HomeCopy = {
  ...
  closingTitle: "Cien veces la misma pregunta",
  closingBody: "Dónde están los baños, a qué hora abre el teleférico, si hay algún sitio sin gluten. Cada día, en el mostrador y por teléfono, casi siempre con cola esperando. A partir de ahora van al asistente: vosotros quedáis para lo que merece una persona.",
...
const ca: HomeCopy = {
  ...
  closingTitle: "Cent vegades la mateixa pregunta",
  closingBody: "On són els lavabos, a quina hora obre el telefèric, si hi ha algun lloc sense gluten. Cada dia, al taulell i per telèfon, gairebé sempre amb cua esperant. A partir d'ara van a l'assistent: vosaltres quedeu per al que mereix una persona.",
...
const fr: HomeCopy = {
  ...
  closingTitle: "Cent fois la même question",
  closingBody: "Où sont les toilettes, à quelle heure ouvre le téléphérique, où manger sans gluten. Chaque jour, au guichet et au téléphone, le plus souvent avec la file qui attend. Désormais elles vont à l'assistant — vous restez pour ce qui mérite quelqu'un.",
...
const de: HomeCopy = {
  ...
  closingTitle: "Hundertmal dieselbe Frage",
  closingBody: "Wo sind die Toiletten, wann öffnet die Seilbahn, gibt es irgendwo glutenfrei. Jeden Tag, am Schalter und am Telefon, meist mit wartender Schlange. Ab jetzt gehen sie an den Assistenten — Sie bleiben für das, was einen Menschen verdient.",
