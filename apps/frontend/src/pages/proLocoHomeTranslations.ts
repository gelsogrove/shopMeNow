...
const it: HomeCopy = {
  ...
  benefits: [
    ...
    { title: "Foto e video, non solo testo", body: "L'assistente manda foto e video direttamente in chat, come fa un amico del posto — non solo un link da aprire." },
  ...
  contentTypes: ["Hotel e B&B", "Ristoranti e agriturismi", "Escursioni e rifugi", "Sagre ed eventi", "Analisi", "Borghi e punti panoramici", "Castelli e chiese", "Cenni storici", "Strutture sportive", "Numeri utili"],
...
const en: HomeCopy = {
  ...
  benefits: [
    ...
    { title: "Photos and video, not just text", body: "The assistant sends photos and videos right in the chat, like a friend who lives there — not just a link to open." },
  ...
  contentTypes: ["Hotels and B&Bs", "Restaurants and farm stays", "Hikes and mountain huts", "Festivals and events", "Analytics", "Villages and viewpoints", "Castles and churches", "Local history", "Sports facilities", "Useful numbers"],
...
const es: HomeCopy = {
  ...
  benefits: [
    ...
    { title: "Fotos y vídeo, no solo texto", body: "El asistente envía fotos y vídeos directamente en el chat, como un amigo del lugar — no solo un enlace que abrir." },
  ...
  contentTypes: ["Hoteles y casas rurales", "Restaurantes y agroturismos", "Rutas y refugios", "Fiestas y eventos", "Análisis", "Pueblos y miradores", "Castillos e iglesias", "Historia local", "Instalaciones deportivas", "Teléfonos útiles"],
...
const ca: HomeCopy = {
  ...
  benefits: [
    ...
    { title: "Fotos i vídeo, no només text", body: "L'assistent envia fotos i vídeos directament al xat, com un amic del lloc — no només un enllaç per obrir." },
  ...
  contentTypes: ["Hotels i cases rurals", "Restaurants i agroturismes", "Rutes i refugis", "Festes i esdeveniments", "Anàlisi", "Pobles i miradors", "Castells i esglésies", "Història local", "Instal·lacions esportives", "Telèfons útils"],
...
const fr: HomeCopy = {
  ...
  benefits: [
    ...
    { title: "Photos et vidéos, pas que du texte", body: "L'assistant envoie photos et vidéos directement dans la conversation, comme un ami du coin — pas seulement un lien à ouvrir." },
  ...
  contentTypes: ["Hôtels et chambres d'hôtes", "Restaurants et fermes-auberges", "Randonnées et refuges", "Fêtes et événements", "Analyses", "Villages et points de vue", "Châteaux et églises", "Histoire locale", "Équipements sportifs", "Numéros utiles"],
...
const de: HomeCopy = {
  ...
  benefits: [
    ...
    { title: "Fotos und Videos, nicht nur Text", body: "Der Assistent schickt Fotos und Videos direkt im Chat, wie ein Freund vor Ort — nicht nur einen Link zum Öffnen." },
  ...
  contentTypes: ["Hotels und Pensionen", "Restaurants und Almhütten", "Wanderungen und Schutzhütten", "Feste und Veranstaltungen", "Analysen", "Dörfer und Aussichtspunkte", "Burgen und Kirchen", "Ortsgeschichte", "Sportanlagen", "Wichtige Nummern"],
