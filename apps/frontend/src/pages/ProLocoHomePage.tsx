          ...
          <div className="overflow-hidden rounded-[2.5rem] shadow-2xl ring-1 ring-white/10" style={{ backgroundColor: GREEN_SURFACE }}>
            <div className="grid items-center gap-12 p-10 sm:p-14 lg:grid-cols-[1fr_auto] lg:gap-16">
              <div className="min-w-0">
                ...
                {/* One clean example conversation */}
                <div className="mt-8 max-w-md space-y-3">
                  ...
                  <div className="rounded-2xl bg-white px-4 py-3 shadow-lg">
                    <p className="text-slate-900 leading-relaxed text-lg">
                      Due noleggi in paese, il più vicino è a 300 m 🚴 <span className="font-semibold">Meteo</span> incerto, vi consiglio domani mattina.
                    </p>
                  </div>
                </div>
