...
const T: Record<Lang, {
  ...
  it: {
    ...
    introPart2: "Per crescere abbiamo bisogno del nostro Cliente 0, una startup del network Neàpolis con cui fare la nostra prima DEMO. Per questo offriamo il servizio completo gratuitamente per il primo anno.",
    offer: "Offriamo il servizio completamente gratuito per un anno.",
    offerFreeWord: "gratuito",
    offerItems: [
      "Sviluppo delle integrazioni con i tuoi sistemi esistenti (CRM, ERP, API, ecc.) a nostro carico",
      "Supporto continuo gratuito per 12 mesi",
    ],
    offerExclusion: "Non copriamo i costi di utilizzo dei modelli LLM (es. OpenAI) né i costi di WhatsApp Business.",
  ...
  en: {
    ...
    introPart2: "To grow, we need our Client 0, a startup within the Neàpolis network to make our first DEMO with. That's why we offer the full service free for the first year.",
    offer: "We offer the service completely free for one year.",
    offerFreeWord: "free",
    offerItems: [
      "We handle all development to integrate with your existing systems (CRM, ERP, API, etc.)",
      "Free continuous support for 12 months",
    ],
    offerExclusion: "LLM usage costs not covered (e.g. OpenAI, WhatsApp Business).",
  ...
  es: {
    ...
    introPart2: "Para crecer necesitamos nuestro Cliente 0, una startup dentro de la red Neàpolis con quien hacer nuestra primera DEMO.",
    offer: "Ofrecemos el servicio completamente gratuito durante un año.",
    offerFreeWord: "gratuito",
    offerItems: [
      "Nos encargamos de todo el desarrollo para integrar con tus sistemas existentes (CRM, ERP, API, etc.)",
      "Soporte continuo gratuito durante 12 meses",
    ],
    offerExclusion: "No cubrimos los costes de uso de los modelos LLM (ej. OpenAI) ni los costes de WhatsApp Business.",
  ...
  pt: {
    ...
    introPart2: "Para crescer precisamos do nosso Cliente 0, uma startup da rede Neàpolis com quem fazer a nossa primeira DEMO. Por isso oferecemos o serviço completo gratuitamente durante o primeiro ano.",
    offer: "Oferecemos o serviço completamente gratuito por um ano.",
    offerFreeWord: "gratuito",
    offerItems: [
      "Tratamos de todo o desenvolvimento para integrar com os seus sistemas existentes (CRM, ERP, API, etc.)",
      "Suporte contínuo gratuito por 12 meses",
    ],
    offerExclusion: "Custos de uso dos modelos LLM não cobertos (ex. OpenAI, WhatsApp Business).",
