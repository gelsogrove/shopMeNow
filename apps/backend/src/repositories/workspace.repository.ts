...
export class WorkspaceRepository implements WorkspaceRepositoryInterface {
  ...
  private mapToDomain(data: any): Workspace {
    return Workspace.create({
      ...
      hasProductCatalog: data.hasProductCatalog ?? true,
      hasCart: data.hasCart ?? true,
      hasOrderTracking: data.hasOrderTracking ?? true,
      needRegistration: data.needRegistration ?? true,
      humanSupportInstructions: data.humanSupportInstructions || null,
      frustrationTriggers: data.frustrationTriggers || null,
      ...
      customChatbotSystemPrompt: data.customChatbotSystemPrompt ?? null,
      customChatbotModel: data.customChatbotModel ?? null,
      customChatbotTemperature: data.customChatbotTemperature ?? null,
      customChatbotMaxTokens: data.customChatbotMaxTokens ?? null,
      customChatbotOperatorBriefingLanguage: data.customChatbotOperatorBriefingLanguage ?? null,
      customChatbotOperatorEmail: data.customChatbotOperatorEmail ?? null,
      customChatbotEmailFrom: data.customChatbotEmailFrom ?? null,
      ...
      widgetErrorMessage: data.widgetErrorMessage ?? null,
  ...
  private mapToDatabase(workspace: Workspace): any {
    return {
      ...
      defaultLanguage: workspace.defaultLanguage ?? null,
      ...
      speechToTextEnabled: workspace.speechToTextEnabled,
      ...
      frustrationTriggers: workspace.frustrationTriggers,
      ...
      customChatbotSystemPrompt: workspace.customChatbotSystemPrompt,
      customChatbotModel: workspace.customChatbotModel,
      customChatbotTemperature: workspace.customChatbotTemperature,
      customChatbotMaxTokens: workspace.customChatbotMaxTokens,
      customChatbotOperatorBriefingLanguage: workspace.customChatbotOperatorBriefingLanguage,
      customChatbotOperatorEmail: workspace.customChatbotOperatorEmail,
      customChatbotEmailFrom: workspace.customChatbotEmailFrom,
      customChatbotEmailSubjectPrefix: workspace.customChatbotEmailSubjectPrefix,
      customChatbotAudioOutput: workspace.customChatbotAudioOutput,
      customChatbotAudioVoices: workspace.customChatbotAudioVoices as any,
      ...
      widgetErrorMessage: workspace.widgetErrorMessage ?? null,
      // 🆕 Translation Settings
