      ...
      return res.status(200).json({
        ...
        data: {
          config: {
            ...
            autoSuggestionsEnabled: workspace.widgetAutoSuggestionsEnabled ?? false,
            quickReplies: Array.isArray(workspace.widgetQuickReplies) ? (workspace.widgetQuickReplies as string[]).slice(0, 4) : [],
          },
          showWidgetChatbot,
          error: null,
        },
