  ...
  getAllWorkspaces = async (
    ...
    try {
      ...
      const serializedWorkspaces = workspaces.map((workspace) => ({
        ...
        webhookTimeout: workspace.webhookTimeout ?? 10000,
        ...
        securityBlockedMessage: (workspace as any).securityBlockedMessage ?? null,
        ...
        videoUrl: workspace.videoUrl ?? null,
        ...
        customChatbotSystemPrompt: workspace.customChatbotSystemPrompt ?? null,
        customChatbotModel: workspace.customChatbotModel ?? null,
        customChatbotTemperature: workspace.customChatbotTemperature ?? null,
        customChatbotMaxTokens: workspace.customChatbotMaxTokens ?? null,
        customChatbotOperatorBriefingLanguage: workspace.customChatbotOperatorBriefingLanguage ?? null,
        customChatbotOperatorEmail: workspace.customChatbotOperatorEmail ?? null,
        customChatbotEmailFrom: workspace.customChatbotEmailFrom ?? null,
        customChatbotEmailSubjectPrefix: workspace.customChatbotEmailSubjectPrefix ?? null,
        customChatbotAudioOutput: workspace.customChatbotAudioOutput ?? null,
        customChatbotAudioVoices: workspace.customChatbotAudioVoices ?? null,
        customChatbotAdvancedSettings: workspace.customChatbotAdvancedSettings ?? null,
