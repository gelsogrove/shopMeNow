...
export async function transcribeAudio(
  ...
  // Manually build multipart/form-data with a simple alphanumeric boundary.
  // OpenRouter rejects boundaries with leading dashes (generated by form-data pkg and openai SDK).
  ...
  try {
    const res = await axios.post(WHISPER_URL, body, {
      headers: {
