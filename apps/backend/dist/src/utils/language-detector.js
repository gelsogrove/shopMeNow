...
exports.detectLanguageFromPhonePrefix = detectLanguageFromPhonePrefix;
exports.getRegistrationText = getRegistrationText;
exports.getLanguageName = getLanguageName;
const PHONE_PREFIX_TO_LANGUAGE = {
    "+39": "it", // Italy
    "+34": "es", // Spain
    "+351": "pt", // Portugal
    "+1": "en", // USA/Canada
 ...
 */
function detectLanguageFromPhonePrefix(phone) {
...
function getRegistrationText(language) {
    return (REGISTRATION_TEXTS[language] || REGISTRATION_TEXTS["en"] // Default to English
    );
}
/**
