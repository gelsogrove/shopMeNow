        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    productName: {
                        type: "string",
                        description: "Il sku [es: PARM-500G] o nome del prodotto da cercare. Preferire sempre il codice dalla lista prodotti.",
                    },
                    formato: {
                        type: "string",
...
exports.CART_MANAGEMENT_FUNCTIONS = [
    ...
    },
    {
        ...
        function: {
            name: "viewCart",
            description: "👀 Mostra il contenuto del carrello del cliente con link sicuro per checkout.",
            parameters: {
                type: "object",
                properties: {},
                required: [],
...
//# sourceMappingURL=agent-functions.config.js.map