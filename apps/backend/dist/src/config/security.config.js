...
exports.getLockoutExpiration = exports.shouldLockAccount = exports.generateRecoveryCodes = exports.validatePassword = exports.getSecurityConfig = void 0;
// ═══════════════════════════════════════════════════════════════════════════════
 ...
 * └─────────────────────────────────────────────────────────────────────────────┘
 */
const ACCOUNT_LOCKOUT_DEFAULTS = {
    /**
     * LOCKOUT THRESHOLD
...
const validatePassword = (password) => {
    const policy = (0, exports.getSecurityConfig)().passwordPolicy;
 ...
 */
const shouldLockAccount = (failedAttempts) => {
    const config = (0, exports.getSecurityConfig)();
 ...
 */
const getLockoutExpiration = () => {
    const config = (0, exports.getSecurityConfig)();
    return new Date(Date.now() + config.accountLockout.durationMs);
};
exports.getLockoutExpiration = getLockoutExpiration;
// ═══════════════════════════════════════════════════════════════════════════════
