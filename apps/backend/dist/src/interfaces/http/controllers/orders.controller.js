    ...
    getCustomerOrders(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logger_1.default.error("[ORDERS] Error fetching customer orders:", error);
                res.status(500).json({
                    success: false,
    ...
    getOrderDetail(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                        ...
                        order: {
                            ...
                            items: order.items.map((it) => {
                                ...
                                return ({
                                    ...
                                    formato: ((_c = it.product) === null || _c === void 0 ? void 0 : _c.formato) || null, // 🧀 Include formato field for products
                ...
                logger_1.default.error("[ORDERS] Error fetching order detail:", error);
                res.status(500).json({
                    success: false,
                    error: "Internal server error"
                });
            ...
            try {
                ...
                if (order.items.length > 0) {
                    order.items.forEach((it) => {
                        var _a, _b, _c, _d;
                        const name = ((_a = it.product) === null || _a === void 0 ? void 0 : _a.name) || ((_b = it.service) === null || _b === void 0 ? void 0 : _b.name) || 'Item';
                        const code = ((_c = it.product) === null || _c === void 0 ? void 0 : _c.Sku) || ((_d = it.service) === null || _d === void 0 ? void 0 : _d.code) || '';
                ...
                logger_1.default.error("[ORDERS] Error downloading invoice:", error);
                res.status(500).json({
                    success: false,
                    error: "Internal server error"
                });
            ...
            try {
                ...
                if (order.items.length > 0) {
                    order.items.forEach((it) => {
                        var _a, _b, _c, _d;
                        const name = ((_a = it.product) === null || _a === void 0 ? void 0 : _a.name) || ((_b = it.service) === null || _b === void 0 ? void 0 : _b.name) || 'Item';
                        const code = ((_c = it.product) === null || _c === void 0 ? void 0 : _c.Sku) || ((_d = it.service) === null || _d === void 0 ? void 0 : _d.code) || 'N/A';
                ...
                logger_1.default.error("[ORDERS] Error downloading DDT:", error);
                res.status(500).json({
                    success: false,
                    error: "Internal server error"
                });
    ...
    deleteOrder(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const deletedOrder = yield this.prisma.orders.deleteMany({
                    where: {
                        id: id,
                ...
                logger_1.default.error("[ORDERS] Error deleting order:", error);
                res.status(500).json({
                    success: false,
