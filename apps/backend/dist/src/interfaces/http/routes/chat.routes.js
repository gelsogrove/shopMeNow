 ...
 */
const chatRouter = (chatController) => {
    ...
    if (process.env.NODE_ENV !== "production") {
         ...
         */
        router.get("/debug/:sessionId", (0, async_middleware_1.asyncHandler)(chatController.getChatSession.bind(chatController)));
    }
    ...
    //   next()
    // },
    (0, async_middleware_1.asyncHandler)(chatController.getRecentChats.bind(chatController)));
    /**
     * @swagger
     * /api/chat/{sessionId}:
     *   get:
     ...
     *         description: Server error
     */
    router.get("/:sessionId", (0, async_middleware_1.asyncHandler)(chatController.getChatSession.bind(chatController)));
    /**
     * @swagger
     ...
     *         description: Server error
     */
    router.get("/:sessionId/messages", (0, async_middleware_1.asyncHandler)(chatController.getChatMessages.bind(chatController)));
    /**
     * @swagger
     ...
     *         description: Server error
     */
    router.post("/:sessionId/mark-read", (0, async_middleware_1.asyncHandler)(chatController.markAsRead.bind(chatController)));
    /**
     * @swagger
     ...
     *         description: Server error
     */
    router.post("/:sessionId/send", (0, async_middleware_1.asyncHandler)(chatController.sendMessage.bind(chatController)));
    /**
     * @swagger
     * /api/chat/{sessionId}:
     *   delete:
     ...
     *         description: Server error
     */
    router.delete("/:sessionId", (0, async_middleware_1.asyncHandler)(chatController.deleteChat.bind(chatController)));
    /**
     * @swagger
     ...
     *         description: Server error
     */
    router.delete("/test/:sessionId", (0, async_middleware_1.asyncHandler)(chatController.deleteChat.bind(chatController)));
    return router;
};
