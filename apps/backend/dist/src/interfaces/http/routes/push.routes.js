...
const pushRoutes = (controller) => {
    const router = (0, express_1.Router)({ mergeParams: true }); // 🔧 FIX: Merge params from parent router
     ...
     *                   type: string
     */
    router.post("/system-notification", controller.sendSystemNotification.bind(controller));
    return router;
};
