...
exports.buildDhlTrackingUrl = exports.config = void 0;
...
exports.config = {
    ...
    dhlTrackingBaseUrl: process.env.DHL_TRACKING_BASE_URL ||
...
const buildDhlTrackingUrl = (trackingNumber) => {
    if (!trackingNumber)
        return null;
    const base = exports.config.dhlTrackingBaseUrl;
    const sep = base.includes("?") ? "&" : "?";
    return `${base}${sep}tracking-id=${encodeURIComponent(trackingNumber)}`;
};
exports.buildDhlTrackingUrl = buildDhlTrackingUrl;
