...
exports.flowMetrics = exports.FlowMetricsCollector = void 0;
...
class FlowMetricsCollector {
    constructor() {
        ...
        logger_1.default.info('[METRICS] FlowMetricsCollector initialized with 1-minute aggregation');
    }
    /**
     * Record metrics for a completed flow execution
     */
    recordFlowExecution(stepTimes, outcome, workspaceId, phoneNumber, messageLength) {
        ...
        logger_1.default.debug(`[METRICS] Recorded flow execution: ${outcome} in ${totalProcessingTime}ms for workspace ${workspaceId}`);
    }
    /**
     * Get current aggregated metrics
     */
    getAggregatedMetrics() {
        return Object.assign({}, this.aggregatedMetrics);
    }
    /**
     ...
     */
    getRecentMetrics(minutesBack = 5) {
     ...
     */
    getPerformanceStats(minutesBack = 60) {
     ...
     */
    getStepPerformanceBreakdown(minutesBack = 60) {
        const recentMetrics = this.getRecentMetrics(minutesBack);
        if (recentMetrics.length === 0) {
            return {};
        }
        const stepKeys = Object.keys(recentMetrics[0].stepTimes);
        const breakdown = {};
    ...
    destroy() {
        ...
        logger_1.default.info('[METRICS] FlowMetricsCollector destroyed');
    }
    ...
    aggregateMetrics() {
        ...
        logger_1.default.debug(`[METRICS] Aggregated metrics updated: ${recentMetrics.length} messages in last hour`);
    }
    updateWorkspaceMetrics(workspaceId, metric) {
        ...
        if (existing) {
            ...
            this.workspaceMetrics.set(workspaceId, Object.assign(Object.assign({}, existing), { messageCount: newCount, averageResponseTime: newAvgResponseTime, errorRate: newErrorRate, lastActivity: Date.now() }));
        }
        else {
...
exports.FlowMetricsCollector = FlowMetricsCollector;
// Global metrics collector instance
exports.flowMetrics = new FlowMetricsCollector();
//# sourceMappingURL=flow-metrics.js.map