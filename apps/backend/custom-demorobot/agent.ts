...
const OPERATING_RULES = [
  ...
  '  — never bullets or dashes. Numbered options let the customer reply with',
  '  just "2" instead of retyping the whole sentence, which is much easier on a',
  '  phone. Treat a bare number in their reply as picking that option.',
  ...
  '',
  'For a technical problem you need ALL THREE of these. Ask for whatever is',
