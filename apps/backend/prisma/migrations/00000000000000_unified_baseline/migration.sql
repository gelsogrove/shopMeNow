...
-- CreateEnum
CREATE TYPE "AgentType" AS ENUM ('ROUTER', 'OPERATOR', 'PRODUCT_SEARCH', 'CART_MANAGEMENT', 'ORDER_TRACKING', 'CUSTOMER_SUPPORT', 'SUMMARY_AGENT', 'PROFILE_MANAGEMENT', 'NOTIFICATIONS', 'SAFETY_TRANSLATION', 'SECURITY', 'TRANSLATION', 'CUSTOM');
...
CREATE TABLE "Workspace" (
    ...
    "creditBalance" DECIMAL(10,2) NOT NULL DEFAULT 29.00,
