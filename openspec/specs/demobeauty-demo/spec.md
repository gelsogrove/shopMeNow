# demobeauty-demo Specification

## Purpose

Defines the public chatbot demo widget for Demobeauty, served at `/demo/demobeauty`, which renders the shared `DemoWidgetPage` component branded as Demobeauty and connected to the custom-demobeauty chatbot module.
