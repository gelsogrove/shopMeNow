# Survey Page Presentation

## Purpose

Defines the presentation requirements for the public survey page (`/survey`): it must share the site's header and card design language so it reads as part of the same product, while keeping its functional behavior unchanged.
