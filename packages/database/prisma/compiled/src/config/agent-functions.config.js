...
exports.PROFILE_MANAGEMENT_FUNCTIONS = exports.SUMMARY_AGENT_FUNCTIONS = exports.CUSTOMER_SUPPORT_FUNCTIONS = exports.ORDER_TRACKING_FUNCTIONS = exports.CART_MANAGEMENT_FUNCTIONS = exports.PRODUCT_SEARCH_FUNCTIONS = exports.ROUTER_FUNCTIONS = void 0;
exports.getAgentFunctions = getAgentFunctions;
exports.getAllFunctions = getAllFunctions;
exports.getAgentFunctionNames = getAgentFunctionNames;
/**
 * Router Agent Functions
 * Pure orchestration - delegates to specialist agents
 */
exports.ROUTER_FUNCTIONS = [
    {
        type: "function",
        function: {
            name: "productSearchAgent",
            description: "🔍 Delega al Product & Services Search Agent. Usare quando cliente cerca prodotti/servizi, categorie, filtri, certificazioni, o seleziona numero da lista.",
            parameters: {
                type: "object",
                properties: {
                    query: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "🛒 Delega al Cart Management Agent. Usare quando cliente vuole gestire carrello (add/remove/view/clear).",
            parameters: {
                type: "object",
                properties: {
                    query: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "📦 Delega al Order Tracking Agent. Usare quando cliente chiede ordini (lista, tracking, fatture, ripeti ordine).",
            parameters: {
                type: "object",
                properties: {
                    query: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "💬 Delega al Customer Support Agent. Usare quando cliente frustrato, problema serio, richiede assistenza umana.",
            parameters: {
                type: "object",
                properties: {
                    query: {
    ...
    },
    {
        ...
        function: {
            ...
            description: "👤 Delega al Profile Management Agent. Usare quando cliente vuole gestire profilo (modifica dati, preferenze) o notifiche push (attiva/disattiva).",
            parameters: {
                type: "object",
                properties: {
                    query: {
...
exports.PRODUCT_SEARCH_FUNCTIONS = [
    ...
    },
    {
        ...
        function: {
            ...
            description: "🔍 PRIORITY 1 - Recupera dettagli completi di un servizio cercandolo per serviceCode (priorità) o nome. OBBLIGATORIO chiamarla quando l'utente seleziona un servizio dalla lista. Ritorna: codice interno (MAI mostrarlo all'utente!), nome, prezzo, descrizione. Il codice interno serve per passare a CartManagementAgent.",
            parameters: {
                type: "object",
                properties: {
                    serviceName: {
                        type: "string",
                        description: "Il serviceCode [es: SHIPPING, GIFT-WRAP] o nome del servizio da cercare. Preferire sempre il codice dalla lista servizi.",
                    },
                },
...
exports.CART_MANAGEMENT_FUNCTIONS = [
    ...
    },
    {
        ...
        function: {
            name: "viewCart",
            description: "👀 Mostra il contenuto del carrello del cliente con lista prodotti, quantità, prezzi e totale. Risponde con visualizzazione testuale inline (nessun link).",
            parameters: {
                type: "object",
                properties: {},
                required: [],
    ...
    },
    {
        ...
        function: {
            name: "updateCartItem",
            description: "✏️ PRIORITY 3.5 - MEDIUM. Modifica la quantità di un prodotto nel carrello. Usare quando cliente dice 'voglio 5 panettoni invece di 3', 'cambia mozzarella a 2', 'metti 3 burrate'. Se newQuantity=0, il prodotto viene rimosso. DOPO modifica → mostra carrello aggiornato inline.",
            parameters: {
                type: "object",
                properties: {
                    productCode: {
 ...
 */
exports.SUMMARY_AGENT_FUNCTIONS = [
 ...
 */
function getAgentFunctions(agentType) {
    switch (agentType) {
        case "ROUTER":
            return exports.ROUTER_FUNCTIONS;
        case "PRODUCT_SEARCH":
            return exports.PRODUCT_SEARCH_FUNCTIONS;
        case "CART_MANAGEMENT":
            return exports.CART_MANAGEMENT_FUNCTIONS;
        case "ORDER_TRACKING":
            return exports.ORDER_TRACKING_FUNCTIONS;
        case "CUSTOMER_SUPPORT":
            return exports.CUSTOMER_SUPPORT_FUNCTIONS;
        case "SUMMARY_AGENT":
            return exports.SUMMARY_AGENT_FUNCTIONS;
        case "PROFILE_MANAGEMENT":
            return exports.PROFILE_MANAGEMENT_FUNCTIONS;
        case "SECURITY":
 ...
 */
function getAgentFunctionNames(agentType) {
