...
exports.platformConfigData = void 0;
exports.getConfigPrice = getConfigPrice;
exports.getConfigFlag = getConfigFlag;
exports.getConfigLimit = getConfigLimit;
exports.platformConfigData = [
    // ============================================================================
    ...
    },
    {
        ...
        description: "Premium plan - €39/month for established businesses (was €49)",
        isActive: true,
    },
    {
        type: "PRICE",
        ...
        description: "Enterprise plan - €129/month for large scale operations (was €149)",
        isActive: true,
    },
    {
        type: "PRICE",
    ...
    // ============================================================================
    {
        ...
        key: "canLogin",
        value: "true",
        description: "Allow users to login. When false: show WIP popup, disable login button",
        isActive: true,
    },
    {
        type: "FLAG",
        key: "canRegister",
        value: "true",
        description: "Allow new user registration. When false: show WIP popup, disable register button",
        isActive: true,
    },
    {
        type: "FLAG",
        ...
        value: "true",
        description: "When true, /index redirects to landing page. When false, redirect users to /auth/login",
        isActive: true,
    },
    // ============================================================================
 ...
 */
function getConfigPrice(data) {
    return parseFloat(data.value);
}
/**
 * Helper to get flag value as boolean
 */
function getConfigFlag(data) {
    return data.value === "true";
}
/**
 * Helper to get limit value as number
 */
function getConfigLimit(data) {
