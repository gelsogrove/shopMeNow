          ...
          non_parte: {
            step_0: {
              ...
              transitionDescriptions: {
                ...
                "001": "001, AL001, error 001 — numeric error code on display",
                "alm": "ALM, ALN, or any other alarm code (not ALM DOOR, not 001/AL001)",
              },
              onInterruptFallback: "Please describe what you see on the washer display 👀",
            },
            caso_sel: {
              type: "ACTION",
              prompt: "The display shows *SEL*, which means the machine is ready and waiting for you to select a wash program.\n\n👉 **Press the button for the program you want** (e.g. 60°, 40°, 30° or Cold).\n👉 If you're not sure which program to choose, check the label on your clothes first.\n\nOnce the program is selected, the machine should start automatically. Let me know what happens.",
              transitions: { default: "non_parte.ask_resolved" },
            },
            caso_push: {
              type: "ACTION",
              prompt: "The display shows *PUSH* followed by a number — this means you've inserted credit but the program hasn't been confirmed yet.\n\n👉 **Press the button for the program you want** and wait a couple of seconds.\n👉 If the machine doesn't respond after pressing, try **pressing the button firmly** one more time.\n\nTell me if the machine starts or what message appears next.",
              transitions: { default: "non_parte.ask_resolved" },
            },
            caso_door: {
              type: "ACTION",
              prompt: "The display shows *DOOR*, which means the washer door isn't closed properly and the machine can't start.\n\n👉 **Open the door completely**, check that no clothes are caught in the rubber seal, and then **close it firmly until you hear a click**.\n👉 Once closed, the message should disappear and you can select your program again.\n\nLet me know if the message goes away or if it stays on the display.",
              transitions: { default: "non_parte.ask_resolved" },
            },
            caso_importo: {
              type: "CHOICE",
            ...
            caso_extra: {
              type: "INFO",
              prompt: "It looks like an *EXTRA* option has been activated on the machine (e.g. extra rinse or pre-wash), which requires additional credit.\n\n👉 If you **don't** want the extra option: **press the lit EXTRA button** to deactivate it. The price on the display should drop back to the standard amount.\n👉 If you **do** want it: **insert the remaining credit** shown on the display to cover the extra cost.\n\nOnce the correct amount is paid, the machine should start normally.",
              isTerminal: true,
            },
            caso_alm_door: {
              type: "ACTION",
              prompt: "The display shows *ALM DOOR*, which means there's a problem with the door — usually something is stuck in the seal or the latch isn't engaging properly.\n\n👉 **Carefully open the door** and check if any clothes, strings, or objects are caught in the rubber seal or between the door and the drum.\n👉 **Remove anything you find**, then **close the door firmly** until you hear a clear click.\n\nLet me know if the alarm message disappears after closing the door.",
              transitions: { default: "non_parte.ask_resolved" },
            },
            caso_001: {
              type: "INFO",
              prompt: "The display shows *Error 001* (or *AL001*) — this usually happens when the program was selected before the payment was confirmed, and the machine state didn't reset correctly.\n\nThis is something that needs to be reviewed by our team to make sure everything is in order.\n👉 **Please do not try to insert more money** — I'm contacting an operator who will assist you right away.",
              isTerminal: true,
            },
            caso_alm_gen: {
              type: "INFO",
              prompt: "The machine has detected an alarm that requires technical review. This type of error can't be resolved from the customer side.\n\n👉 **Please do not continue operating this machine** — using it in this state could cause issues.\n👉 If you need to wash urgently, **please use another available machine** in the meantime.\n\nI'm contacting an operator right now to take care of this. Thank you for your patience 🙏",
              isTerminal: true,
            },
            ask_resolved: {
              type: "CONFIRMATION",
              prompt: "Did that solve the problem? Let me know if the machine is working now or if you're still seeing an issue.",
              transitions: {
            ...
            end_success: {
              type: "INFO",
              prompt: "Perfect, glad we could sort it out! ✅ Your wash cycle should run smoothly now. If you need anything else, I'm here 👍",
              isTerminal: true,
            },
            handle_escalate: {
              type: "INFO",
              prompt: "I understand, and I'm sorry you're still having trouble 😔 I'm going to contact an operator right now so they can help you directly. They'll reach out to you shortly — please stay near the machine if possible.",
              isTerminal: true,
            },
          },
          errore_alm: {
            ...
            alm_acqua: {
              type: "ACTION",
              prompt: "This alarm indicates a water intake problem — the machine isn't receiving water correctly.\n\n👉 **Press the STOP button once** to try to reset the alarm.\n👉 If the alarm clears, you can try starting a new cycle.\n👉 If the alarm **stays on after pressing STOP**, please **use another available machine** and we'll notify maintenance to check this one.\n\nLet me know what happens after you press STOP.",
              isTerminal: true,
            },
            alm_scarico: {
              type: "ACTION",
              prompt: "This alarm indicates a drainage problem — the machine can't drain the water properly.\n\n👉 **Press the STOP button once** to try to reset the machine.\n\n⚠️ **Important**: the door may stay **locked for up to 30 minutes** while the water drains out slowly. This is a safety feature — please don't try to force it open.\n\nIf the alarm persists after pressing STOP, please **use another available machine** and we'll send maintenance to check this one.",
              isTerminal: true,
            },
            alm_door: {
              type: "ACTION",
              prompt: "This alarm is related to the door latch — the machine detects that the door isn't closing or locking properly.\n\n👉 **Press the STOP button once** to reset the alarm.\n👉 Then **open the door**, check that nothing is caught in the rubber seal, and **close it firmly** until you hear a click.\n\nIf the problem continues after trying this, please **use another machine** and we'll report it to maintenance.",
              isTerminal: true,
            },
            alm_var: {
              type: "INFO",
              prompt: "This is a technical fault that can't be resolved on your end — the machine needs to be checked by our maintenance team.\n\n👉 **Please do not continue using this machine** — use another available one instead.\n👉 Don't worry, **we'll provide a compensation** for the inconvenience 👍\n\nI'm notifying the maintenance team right now. Thank you for your patience.",
              isTerminal: true,
            },
          },
          lavaggio_problema: {
            ...
            no_centrifuga: {
              type: "INFO",
              prompt: "It sounds like the spin cycle didn't work properly. This usually happens when the drum is overloaded or the clothes are unevenly distributed inside.\n\n👉 **Open the door** and **split the load into two smaller batches**.\n👉 **Run a Quick spin cycle** (available at €2.50) to finish drying the clothes properly.\n\nIf the problem happens again with a smaller load, let me know and we'll investigate further.",
              isTerminal: true,
            },
            end_bal: {
              type: "INFO",
              prompt: "The display shows *END + bAL*, which means the wash cycle completed but the spin was skipped because the load was unbalanced. Your clothes may still be quite wet.\n\n👉 **Open the door** and **redistribute the clothes more evenly** inside the drum, or **split the load** if there's too much in there.\n👉 **Run a Quick spin cycle** (available at €2.50) — this should properly spin-dry everything.\n\nThis is a common issue with large or heavy items like towels and jeans.",
              isTerminal: true,
            },
          },
        },
...
After reset the context is wiped and the Router will ask again from step 1.`,
    ...
    flows: {
          non_parte: {
            ...
            display_blank: {
              type: "ACTION",
              prompt: "If the display is completely dark or blank, the dryer may need a simple reset to come back to life.\n\n👉 **Open the door** and **wait about 10 seconds** before doing anything else.\n👉 Then **close the door firmly** until you hear a click, and check if the display turns on.\n\nIf the display stays blank after this, the machine may have a power issue — in that case, please **use another available dryer** and we'll report this one to maintenance.",
              transitions: { default: "non_parte.ask_resolved" },
            },
            door_issue: {
              type: "ACTION",
              prompt: "The door latch might be stuck or not engaging properly. This prevents the dryer from starting as a safety measure.\n\n👉 **Check that no clothes or fabric are caught** in the door seal or hinge area.\n👉 **Close the door firmly** and push until you hear a clear click — it needs a bit of force sometimes.\n\nLet me know if the door clicks shut and the display changes.",
              transitions: { default: "non_parte.ask_resolved" },
            },
            credit_issue: {
              type: "ACTION",
              prompt: "The display is showing a price, which means the dryer needs more credit before it can start.\n\n👉 **Check the exact amount** shown on the display.\n👉 **Insert coins or tap contactless** at the central unit to add the required credit.\n👉 After paying, **press the PAUSE button** firmly to confirm and start the cycle.\n\nIf the dryer still doesn't start after paying the full amount, let me know and we'll look into it.",
              transitions: { default: "non_parte.ask_resolved" },
            },
            ask_resolved: {
              type: "CONFIRMATION",
              prompt: "Did that solve the problem? Let me know if the dryer is working now or if you're still seeing an issue.",
              transitions: {
                YES: "non_parte.end_success",
                NO: "non_parte.handle_escalate",
              },
            ...
            end_success: {
              type: "INFO",
              prompt: "Perfect, glad we could sort it out! ✅ Your clothes will be dry soon. If you need anything else, I'm here 👍",
              isTerminal: true,
            },
            handle_escalate: {
              type: "INFO",
          ...
          errore_reset: {
            ...
            allarme: {
              type: "ACTION",
              prompt: "An alarm or warning light means the dryer detected something unusual. Let's try to reset it step by step.\n\n👉 **Press and hold the STOP button for 3 seconds** until the alarm clears.\n👉 Then **open the door** and **pull out the lint filter** — remove any lint or debris, and put the filter back in place.\n👉 **Close the door firmly** and try starting a new cycle.\n\nLet me know if the alarm goes away or if it comes back.",
              transitions: { default: "errore_reset.ask_resolved" },
            },
            non_scalda: {
              type: "ACTION",
              prompt: "If the dryer ran a full cycle but your clothes are still damp, the most common cause is a clogged lint filter reducing the heat flow.\n\n👉 **Pull out the lint filter** (it's usually at the front, below the door) and **remove all the lint and debris**.\n👉 **Put the filter back in** and **run a new drying cycle**.\n\nIf the clothes are still damp after a clean filter and a full cycle, the heating element may need professional service. In that case, please **use another available dryer** and we'll send maintenance to check this one.",
              transitions: { default: "errore_reset.ask_resolved" },
            },
            mid_stop: {
              type: "ACTION",
              prompt: "When a dryer stops in the middle of a cycle, it's usually because of a safety shut-off triggered by overheating. This can happen with large loads or when the lint filter is blocked.\n\n👉 **Wait about 5 minutes** for the dryer to cool down completely.\n👉 While waiting, **pull out the lint filter and clean it** thoroughly.\n👉 Then try starting again with a **smaller load** if possible.\n\nLet me know if it starts up again or if it shuts off a second time.",
              transitions: { default: "errore_reset.ask_resolved" },
            },
            ask_resolved: {
              type: "CONFIRMATION",
